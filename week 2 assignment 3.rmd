---
title: "Coursera R Week 4 programming assignment 3"
author: "Mike Fang"
date: "March 13, 2016"
...
The functions could be improved further with some fine tuning, but I'd say it is good enough for passing the course. 

The first function finds best hospital in state

```{r best, echo=TRUE, warning=FALSE}
...
```{r rankhospital, echo=TRUE, warning=FALSE} 
...
```{r rankall, echo=TRUE, warning=FALSE}
